...
const Status = () => {
      ...
      setIncidents([
        {
          ...
          description: 'Users may experience slower loading times for static assets.'
        },
        {
          id: 2,
  ...
  const overallStatus = operationalCount === services.length ? 'All Systems Operational' : 
                       operationalCount > services.length / 2 ? 'Partial Outage' : 'Major Outage';
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <div className={`w-4 h-4 rounded-full mr-4 ${
              operationalCount === services.length ? 'bg-green-500' : 
              operationalCount > services.length / 2 ? 'bg-yellow-500' : 'bg-red-500'
            }`} />
            <div>
              <h2 className="text-2xl font-bold text-gray-900">{overallStatus}</h2>
            ...
            {services.map((service, index) => {
              ...
              return (
                <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex items-center">
                    <StatusIcon className={`w-5 h-5 mr-2 ${statusConfig.text}`} />
      ...
      <Card className="mt-8 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">90-Day Uptime History</h3>
