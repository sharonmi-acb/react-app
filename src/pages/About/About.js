  ...
  const timeline = [
    {
      ...
      description: 'FlowTech was born with a vision to revolutionize business operations through technology.'
    },
    {
      year: '2021',
      title: 'First Product Launch',
      description: 'Launched our flagship SaaS platform with 100 initial customers.'
    },
    {
      year: '2022',
      title: 'Series A Funding',
      description: 'Raised $10M in Series A funding to accelerate growth and development.'
    },
    {
      year: '2023',
    ...
    },
    {
      ...
      description: 'Integrated advanced AI capabilities across our platform suite.'
    },
    {
      year: '2025',
      title: 'Market Leader',
      description: 'Recognized as the leading SaaS solution in our category with 10,000+ customers.'
    }
  ];
      ...
      <Section background="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50" padding="py-20">
        <Container>
          <div className="text-center">
            <Badge variant="primary" className="mb-4">About FlowTech</Badge>
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Building the Future of
              <span className="gradient-text"> Business Technology</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              We're a passionate team of innovators dedicated to empowering businesses worldwide 
              with cutting-edge SaaS solutions that drive growth, efficiency, and success.
            </p>
          ...
          <Grid cols={2} gap={8}>
            <Card padding="p-8" hover>
              ...
              <p className="text-gray-600 leading-relaxed">
                To empower businesses of all sizes with intelligent, scalable SaaS solutions 
                that streamline operations, boost productivity, and drive sustainable growth 
                in the digital age.
              </p>
            </Card>
            ...
            <Card padding="p-8" hover>
              ...
              <p className="text-gray-600 leading-relaxed">
                To become the world's most trusted technology partner, transforming how 
                businesses operate and succeed through innovative, user-centric solutions 
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Whether you're looking to join our team or partner with us, 
