  ...
  const jobs = [
    {
      ...
      requirements: ['5+ years of full-stack development', 'Experience with React and Node.js', 'Cloud platform experience'],
      posted: '2 days ago'
    },
    {
      id: 2,
      ...
      type: 'Full-time',
      salary: '$120k - $160k',
      description: 'Design intuitive user experiences for our SaaS platform, working closely with product and engineering teams.',
      requirements: ['3+ years of product design experience', 'Proficiency in Figma', 'Experience with design systems'],
      posted: '1 week ago'
    },
    {
      id: 3,
      ...
      description: 'Generate and qualify leads for our enterprise sales team while building relationships with potential customers.',
      requirements: ['1+ years of sales experience', 'Excellent communication skills', 'CRM experience preferred'],
      posted: '3 days ago'
    },
    {
      id: 4,
      ...
      requirements: ['AWS/GCP experience', 'Kubernetes knowledge', 'Infrastructure as Code (Terraform)'],
      posted: '5 days ago'
    },
    {
      id: 5,
      ...
      type: 'Full-time',
      salary: '$90k - $120k',
      description: 'Help our customers achieve success with our platform while driving retention and expansion.',
      requirements: ['2+ years in customer success', 'SaaS experience', 'Strong analytical skills'],
      posted: '1 day ago'
    },
    {
      id: 6,
      ...
      type: 'Full-time',
      salary: '$100k - $130k',
      description: 'Lead marketing campaigns and initiatives to drive brand awareness and lead generation.',
      requirements: ['3+ years of marketing experience', 'Digital marketing expertise', 'Analytics experience'],
      posted: '1 week ago'
    }
  ];
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Join a team of passionate innovators who are revolutionizing how businesses operate. 
              We're looking for talented individuals to help us shape the future of SaaS technology.
            </p>
      ...
      <Section background="bg-white">
        <Container>
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Work at FlowTech?</h2>
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <div className="flex items-center space-x-4 mb-4">
                          <Badge variant={getDepartmentBadgeVariant(job.department)}>
                            {job.department}
                          </Badge>
      ...
      <Section background="bg-white">
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We foster an inclusive, collaborative environment where everyone can do their best work
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Work alongside talented individuals from diverse backgrounds</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Push boundaries and work on cutting-edge technology</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Advance your career with mentorship and learning programs</p>
                  </div>
                </div>
              </div>
            </div>
