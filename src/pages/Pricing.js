...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      notIncluded: ["Enterprise security", "Dedicated account manager"],
      popular: true,
      color: "purple",
    },
    {
  ...
  const testimonials = [
    {
      ...
      content:
        "FlowTech has transformed how our team collaborates. The Professional plan gives us everything we need.",
      rating: 5,
    },
    {
      name: "Sarah Kim",
      ...
      content:
        "Started with the Starter plan and upgraded as we grew. The pricing is transparent and fair.",
      rating: 5,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Start free and scale as you grow. No hidden fees, no complex
              pricing tiers.
            </p>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of companies already using FlowTech to transform
